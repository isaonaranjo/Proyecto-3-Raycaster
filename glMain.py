...
textures = {
    '1' : pygame.image.load('textura1.png'),
    '2' : pygame.image.load('textura2.png'),
    '3' : pygame.image.load('textura3.png')
    }

enemies = [{"x": 175,
            "y": 180,
            "texture" : pygame.image.load('imagen1.png')},

           {"x": 400,
            "y": 220,
            "texture" : pygame.image.load('imagen2.png')},

           {"x": 350,
            "y": 400,
            "texture" : pygame.image.load('imagen3.png')}    
    ]
